class productCard extends HTMLElement{
    constructor(){
        ...
        //Esto es en caso de no usar el attributeChangeCallback()
        // this.title = this.getAttribute("title");
        // this.titleLogo = this.getAttribute("titleLogo")
    ...
    static get observedAttributes(){
        return ["image","title","price","description","collection"]//atributos que debe observar
    }
    ...
    getTemplate() {
        ...
        <main class="container">
            <section class="imgBox">
                <img src=${this.image} alt="Zapatos deportivos para correr color azul"/>
            </section>
